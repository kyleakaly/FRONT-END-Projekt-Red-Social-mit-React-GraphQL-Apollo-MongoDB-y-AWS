...
function checkDEV() {
  __DEV__ ? invariant2("boolean" === typeof DEV_default, DEV_default) : invariant2("boolean" === typeof DEV_default, 36);
}
...
function getFragmentQueryDocument(document, fragmentName) {
  ...
  if (typeof actualFragmentName === "undefined") {
    __DEV__ ? invariant2(fragments.length === 1, "Found ".concat(fragments.length, " fragments. `fragmentName` must be provided when there is not exactly 1 fragment.")) : invariant2(fragments.length === 1, 42);
...
function getFragmentFromSelection(selection, fragmentMap) {
  switch (selection.kind) {
    ...
    case "FragmentSpread": {
      ...
      __DEV__ ? invariant2(fragment, "No fragment named ".concat(selection.name.value, ".")) : invariant2(fragment, 43);
      return fragment;
    }
    default:
      return null;
...
var canUseWeakMap, canUseWeakSet, canUseSymbol, canUseDOM, usingJSDOM, canUseLayoutEffect;
...
function toPromise(observable) {
  ...
  return new Promise(function(resolve4, reject) {
    observable.subscribe({
      next: function(data) {
        if (completed) {
          __DEV__ && invariant2.warn("Promise Wrapper does not support multiple results from Observable");
        } else {
          completed = true;
          resolve4(data);
        }
  ...
  "node_modules/@apollo/client/cache/inmemory/entityStore.js"() {
    ...
    EntityStore = function() {
      ...
      EntityStore2.prototype.merge = function(older, newer) {
        ...
        if (!incoming)
          return;
        __DEV__ ? invariant2(typeof dataId === "string", "store.merge expects a string ID") : invariant2(typeof dataId === "string", 1);
...
function assertSelectionSetForIdValue(store, field, fieldValue) {
  if (!field.selectionSet) {
    ...
    workSet_1.forEach(function(value) {
      if (isNonNullObject(value)) {
        __DEV__ ? invariant2(!isReference(value), "Missing selection set for object of type ".concat(getTypenameFromStoreObject(store, value), " returned for query field ").concat(field.name.value)) : invariant2(!isReference(value), 5);
...
function keyFieldsFnFromSpecifier(specifier) {
  ...
  return info.keyFieldsFn || (info.keyFieldsFn = function(object, context) {
    ...
    var keyObject = context.keyObject = collectSpecifierPaths(specifier, function(schemaKeyPath) {
      ...
      __DEV__ ? invariant2(extracted !== void 0, "Missing field '".concat(schemaKeyPath.join("."), "' while extracting keyFields from ").concat(JSON.stringify(object))) : invariant2(extracted !== void 0, 2);
      return extracted;
    });
...
function normalizeReadFieldOptions(readFieldArgs, objectOrReference, variables) {
  ...
  if (__DEV__ && options.from === void 0) {
    __DEV__ && invariant2.warn("Undefined 'from' passed to readField with arguments ".concat(stringifyForDisplay(Array.from(readFieldArgs))));
  }
  ...
  "node_modules/@apollo/client/cache/inmemory/policies.js"() {
    ...
    Policies = function() {
      ...
      Policies2.prototype.setRootTypename = function(which, typename) {
        ...
        if (typename !== old) {
          __DEV__ ? invariant2(!old || old === which, "Cannot change root ".concat(which, " __typename more than once")) : invariant2(!old || old === which, 3);
          if (old)
            ...
            if (supertypeSet.has(supertype)) {
              if (!typenameSupertypeSet.has(supertype)) {
                if (checkingFuzzySubtypes) {
                  __DEV__ && invariant2.warn("Inferring subtype ".concat(typename, " of supertype ").concat(supertype));
                }
      ...
      StoreWriter2.prototype.processSelectionSet = function(_a5) {
        ...
        this.flattenFields(selectionSet, result2, context, typename).forEach(function(context2, field) {
          ...
          if (value !== void 0) {
            ...
            __DEV__ && invariant2.error("Missing field '".concat(resultKeyNameFromField(field), "' while writing result ").concat(JSON.stringify(result2, null, 2)).substring(0, 1e3));
          }
        });
        try {
...
//# sourceMappingURL=chunk-74JPEVEE.js.map
